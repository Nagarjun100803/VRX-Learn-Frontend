        ...
        <div className="p-8 max-w-5xl mx-auto flex items-center justify-between gap-6">
          <div className="space-y-1">
            ...
            <p className="text-sm text-text-secondary">
              {isAdmin ? "Manage course assignments" : "View course assignments"}
            </p>
          </div>
          ...
          <div className="space-y-1">
            {assignments.map((assignment) => (
              <div 
                ...
                className="flex items-center group px-4 py-4 bg-bg-primary rounded-card border border-transparent hover:border-border-subtle hover:bg-bg-secondary transition-all cursor-pointer"
              >
                ...
                <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                  <div className="size-8 flex items-center justify-center text-text-secondary p-1">
                    <Eye className="size-4 opacity-40 shrink-0" />
                  </div>
                  {isAdmin && (
                    <>
                      <button 
                      ...
                      <button 
                        ...
                        className="size-8 flex items-center justify-center rounded-button text-text-secondary hover:text-accent-red hover:bg-accent-red/5 transition-all"
                      >
